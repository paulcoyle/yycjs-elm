...
view address model =
  Html.div
    ...
    , viewColorMenu model.color model.colorMenu
    ]
...
viewColorMenu : Color -> Menu.Model Color -> Html.Html
viewColorMenu selected menu =
  Menu.view selected menu
